...
impl Shell {
    ...
    pub fn update_pointer_position(
        ...
        let location = position.to_local(output);
        ...
        self.update_cursor_render_state(output, seat, position, now);
    }
